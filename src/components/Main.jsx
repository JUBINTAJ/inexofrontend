...
export default function UserComplaintsPage() {
  ...
  if (isLoading) return <div className="text-center py-10">Loading complaints...</div>;
  if (error) return <div className="text-center text-red-500 py-10">Failed to load complaints.</div>;
